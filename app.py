...
st.caption("Streamlit app that loads your trained model from `winequality.pkl`.")
...
for i, feat in enumerate(FEATURES):
    with cols[i % 2]:
        # Generic input with a reasonable default
...
if st.button("Predict"):
    ...
    try:
        ...
        st.error(
            "Prediction failed. Most common reasons:\n"
            "- The model was trained with different feature names or order.\n"
            "- The pickle expects preprocessing not included in the pickle.\n"
            "Make sure your pickle contains the full pipeline or adjust FEATURES accordingly."
        )
        st.exception(e)
